...
<template>
    <div>
        <button class="font-medium text-sm inline-flex items-center justify-center border leading-5 shadow-sm transition duration-150 ease-in-out rounded-full w-full py-2" :class="[{
        ...
        }]" :disabled="isLoading | disabled" @click.prevent="$emit('click')" type="submit">
